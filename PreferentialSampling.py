...
#v ∈ SA and c ∈ C by
# |v| x |c| / |D| 
def expectedSizes(sp,sn,fp,fn,rest): #len(DP,DN,FP,FN,rest)
    total=sp+sn+fp+fn+rest
    d={}
...
def PreferentialSampling(target,protected,clf,df,adClass,disClass,adAttr=None,disAttr=None):
